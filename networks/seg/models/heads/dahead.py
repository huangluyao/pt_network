...
from ...specific import SelfAttentionBlock
from ...utils.misc import add_prefix
from ....base.cnn.components import Scale, ConvModule
...
class DAHead(BaseDecodeHead):
    ...
    def __init__(self, pam_channels, **kwargs):
        ...
        self.pam = PAM(self.head_width, pam_channels)
        ...
        self.pam_conv_seg = nn.Conv2d(
            self.head_width, self.num_classes, kernel_size=1)
