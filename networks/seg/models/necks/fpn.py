...
from base.cnn import ConvModule, xavier_init
...
class FPN(nn.Module):
    ...
    extra_convs_on_inputs : bool, deprecated
        Whether to apply extra convs
        on the original feature from the backbone. If True,
        it is equivalent to `add_extra_convs='on_input'`. If False, it is
        equivalent to set `add_extra_convs='on_output'`. Default to True.
    relu_before_extra_convs : bool
        Whether to apply relu before the extra
        conv. Default: False.
    no_norm_on_lateral : bool
        Whether to apply norm on lateral.
        Default: False.
    conv_cfg : dict
    ...
    act_cfg : str
        Config dict for activation layer in ConvModule.
        Default: None.
    upsample_cfg : dict
        Config dict for interpolate layer.
