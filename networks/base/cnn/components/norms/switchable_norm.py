...
@NORM_LAYERS.register_module('SwitchBN1d')
...
@NORM_LAYERS.register_module('SwitchBN')
...
@NORM_LAYERS.register_module('SwitchBN3d')
...
NORM_LAYERS.register_module('SwitchBN2d', module=SwitchNorm2d)
