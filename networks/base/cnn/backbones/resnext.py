from ..components import build_conv_layer, build_norm_layer
...
class Bottleneck(ResNetBottleneck):
    ...
    base_channels : int
        Middle channels of the first stage. Default: 64.
    groups : int
        Groups of conv2.
    width_per_group : int
        Width per group of conv2. 64x4d indicates
...
class ResNeXt(ResNet):
    ...
    ----------
    depth : int
        Network depth, from {50, 101, 152}.
    groups : int
        Groups of conv2 in Bottleneck. Default: 32.
    width_per_group : int
        Width per group of conv2 in Bottleneck.
        Default: 4.
    in_channels : int
        Number of input image channels. Default: 3.
    stem_channels : int
        Output channels of the stem layer. Default: 64.
    num_stages : int
    ...
    out_levels : Sequence[int]
        ...
        If only one stride is specified, a single tensor (feature map) is returned,
