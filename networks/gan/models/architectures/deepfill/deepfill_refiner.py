...
class DeepFillRefiner(nn.Module):
    ...
    def __init__(self,
        ...
        self.encoder_attention = build_module(encoder_attention)
        self.encoder_conv = build_module(encoder_conv)
        self.contextual_attention_neck = build_module(contextual_attention)
